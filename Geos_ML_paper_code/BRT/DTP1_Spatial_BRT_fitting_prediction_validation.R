...
## Boosted Regression Model including lat long as covariates
...
###################################################################################################
###################################################################################################
output_path1 <- paste0(drive_path, "Methods_comparison_paper/Ortis/DTP1/JackKnife/")
...
nrast <- 10  # Number of replicates to run (e.g., 10, 30, 50, 100, 200)
...
writeRaster(mean.rast, paste0(output_path1, "Spatia_GBM_mean_raster_dtp1_", nrast,".tif"), 
            overwrite = T)
writeRaster(sd.rast, paste0(output_path1, "Spatial_GBM_stddev_raster_dtp1_", nrast,".tif"), 
            overwrite = T)
