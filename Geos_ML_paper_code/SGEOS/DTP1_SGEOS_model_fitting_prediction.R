...
zero.clust <- which(is.na(vaxdata$Age12_23_Tot)|vaxdata$Age12_23_Tot<=1)
...
Numvacc    <- vaxdata$Age12_23_Vax
weights    <- vaxdata$Age12_23_Tot
...
write.csv(param.all, paste0(filePathData2, "parameter_output_smooth_dtp1_12_23.csv"))
...
write.csv(ds, paste0(filePathData2, "obsvpred_smooth_dtp1_12_23.csv"))
...
writeRaster(rr.mean, paste0(filePathData2, "inla_vax_smooth_dtp1_12_23_mean_v1.tif"), overwrite=TRUE)
writeRaster(rr.sd,   paste0(filePathData2, "inla_vax_smooth_dtp1_12_23_sd_v1.tif"), overwrite=TRUE)
writeRaster(rr.low,  paste0(filePathData2, "inla_vax_smooth_dtp1_12_23_low_v1.tif"), overwrite=TRUE)
writeRaster(rr.up,   paste0(filePathData2, "inla_vax_smooth_dtp1_12_23_up_v1.tif"), overwrite=TRUE)
writeRaster(rr.med,  paste0(filePathData2, "inla_vax_smooth_dtp1_12_23_median_v1.tif"), overwrite=TRUE)
...
write.csv(dist_out, paste0(filePathData2, "District_smooth_estimates_dtp1_12_23_v1.csv"))
...
write.csv(dist_out, paste0(filePathData2, "State_smooth_estimates_dtp1_12_23_v1.csv"))
...
write.csv(dist_out, paste0(filePathData2, "Region_smooth_estimates_dtp1_12_23_v1.csv"))


#Threshold probability calculations - 80%
...
writeRaster(rr.80, paste0(filePathData2, "inla_vax_smooth_dtp1_12_23_80perc_thresh_v1.tif"), overwrite=TRUE)
