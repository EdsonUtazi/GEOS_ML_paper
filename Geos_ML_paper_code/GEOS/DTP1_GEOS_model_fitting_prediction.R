...
vaxdata <- read.csv(paste0(data_path,"NG_Vax_DTP1.csv"), header=TRUE) #Vaccination data
...
write.csv(param.all, paste0(output_path, "parameter_output_dtp1_12_23.csv"))
...
write.csv(ds, paste0(output_path, "obsvpred_dtp1_12_23.csv"))
...
writeRaster(rr.mean, paste0(output_path, "inla_vax_dtp1_12_23_mean.tif"), overwrite=TRUE)
writeRaster(rr.sd,   paste0(output_path, "inla_vax_dtp1_12_23_sd.tif"), overwrite=TRUE)
writeRaster(rr.low,  paste0(output_path, "inla_vax_dtp1_12_23_low.tif"), overwrite=TRUE)
writeRaster(rr.up,   paste0(output_path, "inla_vax_dtp1_12_23_up.tif"), overwrite=TRUE)
writeRaster(rr.med,  paste0(output_path, "inla_vax_dtp1_12_23_median.tif"), overwrite=TRUE)
...
write.csv(dist_out, paste0(output_path, "District_estimates_dtp1_12_23.csv"))
...
write.csv(dist_out, paste0(output_path, "State_estimates_dtp1_12_23.csv"))
...
write.csv(dist_out, paste0(output_path, "Region_estimates_dtp1_12_23.csv"))
...
writeRaster(rr.95, paste0(output_path, "inla_vax_dtp1_12_23_95perc_thresh.tif"), overwrite=TRUE)
